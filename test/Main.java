...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (choice == 1) {
            game = new BullsAndCows(42, 4, BinaryColour.values());
        } else {
            game = new MultiColourMastermindGame(42, 4, MultiColour.values());
        }
    ...
    private static void makeGuess(MastermindGame game) {
        ...
        if (game instanceof BullsAndCows) {
            ...
            for (int i = 0; i < 4; i++) {
                ...
                guess.add(BinaryColour.valueOf(color));
            }
            game.play(new BullsAndCowsCode(castList(guess, BinaryColour.class)));
        } else {
